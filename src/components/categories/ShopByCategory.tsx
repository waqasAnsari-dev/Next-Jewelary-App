  ...
  return (
    <section className="w-full py-12 sm:py-16 md:py-20 lg:py-24">
      ...
      <div className="mb-8 px-4 text-center sm:mb-14 sm:px-6 md:mb-16">
        <h2 className="text-3xl font-medium leading-tight tracking-[-1px] text-[#292929] sm:text-[48px] md:text-[58px] lg:text-[64px]">
          Shop by Category
        </h2>

        <p className="mt-3 text-sm font-normal text-[#858585] sm:mt-4 sm:text-[17px] md:text-[19px]">
